...
/**
 * Preview mode display for notebooks showing generated markdown with lazy chart image generation
 */
export function NotebookPreview({ cells, onChartImagesGenerated }: NotebookPreviewProps) {
